...
function playRound(computer, player) {
    // Σιγουρευόμαστε ότι συγκρίνουμε μικρά γράμματα
...
function game() {
    ...
    while (playerScore < 5 && computerScore < 5) {
        // Ζητάμε το input ΠΡΙΝ μπούμε στο check της isCancelled
        input = prompt("New Game! First to 5 wins.\nCurrent Score: " + playerScore + "-" + computerScore + "\nChoose your weapon:\nRock 🤟🏼, Paper 🧻 or Scissors ✂️!");

        // Αν ο χρήστης πατήσει Cancel στο αρχικό prompt της game, η isCancelled θα το πιάσει
        while (isCancelled() === false) { }
